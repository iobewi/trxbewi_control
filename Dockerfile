...
# add pca9685_hardware
RUN git clone -b dev_position https://github.com/iobewi/pca9685_ros2_control.git \
    src/pca9685_ros2_control
...
CMD ["ros2","launch","trxbewi_control","control_manager.launch.py"]
